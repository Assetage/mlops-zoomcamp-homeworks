...
def calculate_metrics_postgresql(curr, i):
	...
	fare_amount_05quantile = result['metrics'][4]['result']['current']['value']
	...
	curr.execute(
		...
		(begin + datetime.timedelta(i), prediction_drift, num_drifted_columns, share_missing_values, fare_amount_05quantile)
	)
